        ...
        <div ref={wordRef} className={S.word}>
          <div className={S.home}>
            <div className={S.letter}>
              <Alphabets dataIndex={1} letterIndex={8} ref={letterRefs[0]} />
            </div>
            <div className={S.letter}>
              <Alphabets dataIndex={2} letterIndex={15} ref={letterRefs[1]} />
            </div>
            <div className={S.letter}>
              <Alphabets dataIndex={3} letterIndex={13} ref={letterRefs[2]} />
            </div>
            <div className={S.letter}>
              <Alphabets dataIndex={4} letterIndex={5} ref={letterRefs[3]} />
            </div>
          </div>
          <p className={S.and}>&</p>
          <div className={S.art}>
            <div className={S.letter}>
              <Alphabets dataIndex={7} letterIndex={1} ref={letterRefs[4]} />
            </div>
            <div className={S.letter}>
              <Alphabets dataIndex={6} letterIndex={18} ref={letterRefs[5]} />
            </div>
            <div className={S.letter}>
              <Alphabets dataIndex={9} letterIndex={20} ref={letterRefs[6]} />
            </div>
          </div>
        </div>
      </div>
