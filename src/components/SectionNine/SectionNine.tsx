    ...
    <section id="section-nine" data-scroll-section>
      <div className={S.section}>
        ...
        <div className={S.right}>
          <img
            className={S.image1}
            src="https://res.cloudinary.com/ihill/image/upload/v1697972040/rainbow_wig_ivdqmc.jpg"
            alt=""
          />
          <img
            className={S.image2}
            src="https://res.cloudinary.com/ihill/image/upload/v1697885065/pink_headphones_qanfn3.jpg"
            alt=""
          />
          <img
            className={S.image3}
            src="https://res.cloudinary.com/ihill/image/upload/v1697880510/abstract_face_glod2d.jpg"
            alt=""
          />
          <p
            data-scroll
